app.service('articles', function(){
    ...
    { id: 1,
    	...
    	bgImage: {
            path: "images/thumbs/featured/kleancierge_logo_fb",
            webp: true,
            jpg: true
        },
        ...
        postImages: [
            {
                path: "images/thumbs/post/IMG_0748",
                webp: true,
                jpg: true
            },
            {
                path: "images/thumbs/post/IMG_0380",
                webp: true,
                jpg: true
            }
        ],
    ...
    {  id: 2,
        ...
        bgImage: {
            path: "images/thumbs/featured/road_salt",
            webp: true,
            jpg: true
        },
        ...
        postImages: [
            {
                path: "images/thumbs/post/salt_covered",
                webp: true,
                jpg: true
            },
            {
                path: "images/thumbs/post/rusted_car",
                webp: true,
                jpg: true
            }
        ],
    ...
    {  id: 3,
        ...
        bgImage: {
            path: "images/thumbs/featured/happy_employees",
            webp: true,
            jpg: true
        },
        ...
        postImages: [
            {
                path: "images/thumbs/post/happy_employees_1",
                webp: true,
                jpg: true
            },
            {
                path: "images/thumbs/post/happy_employees_2",
                webp: true,
                jpg: true
            }
        ],
    ...
    {  id: 4,
        ...
        bgImage: {
            path: "images/thumbs/featured/progress_perf",
            webp: true,
            jpg: true
        },
        ...
        postImages: [
            {
                path: "images/thumbs/post/bird_poop",
                webp: true,
                jpg: true
            },
            {
                path: "images/thumbs/post/my_floor_mat",
                webp: true,
                jpg: true
            }
        ],
    ...
    {  id: 5,
        ...
        postImages: [
            {
                path: "images/thumbs/post/soap_bucket",
                webp: true,
                jpg: true
            },
            {
                path: "images/thumbs/post/car_wash",
                webp: true,
                jpg: true
            }
        ],
